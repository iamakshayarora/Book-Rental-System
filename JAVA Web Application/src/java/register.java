...
public class register extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String agesignup = request.getParameter("agesignup");
            ...
            {
            stmt.executeUpdate("insert into user (username,age,email,password) values('"+usernamesignup+"','"+agesignup+"','"+emailsignup+"','"+passwordsignup+"')");
